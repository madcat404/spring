...
<#--                            <div class="image" style="background: url('/images/1.jpg');"></div>-->
                            <div class="image">
                        ...
                        <div class="col-6 tile_1_info" style="margin-top: 30px;">
                            <div class="tile_1_header">워머
                            </div>
                            <div class="tile_1_subheader"><p>뛰어나고 안정적인 발열 기능으로 적정 온도의 시트 환경 제공</p>
                            </div>
                            <div class="tile_1_body"><p>탑승자 니즈에 맞는 적정 온도를 제공하여 따뜻한 시트 환경을 제공합니다.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<#--                                <div class="image" style="background: url('/images/2.jpg');">-->
<#--                                </div>-->
                                <div class="image">
                                    <video autoplay muted loop>
                                        <source src="/videos/new_seat_heat_7s.mp4" type="video/mp4">
