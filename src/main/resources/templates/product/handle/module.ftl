                ...
                <div class="tile_1_img_left">
                    <div class="row">
                        ...
                        <div class="col-6 tile_1_info" style="margin-top: 30px;">
                            <div class="tile_1_header">발열핸들
                            </div>
                            <div class="tile_1_subheader"><p>겨울철 STEERING의 차가움 제거</p>
                            </div>
                            <div class="tile_1_body"><p>겨울철 차량 운전 시 STEERING의 차가움을 제거하여 쾌적한 운전 환경을 제공합니다.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <#if device == "mobile">
                            <div class="col-6 image-container mobileOnlyFlex" style="padding-left: 0px">
                                <div class="image">
                                    <video autoplay muted loop>
                                        <source src="/videos/handle_heat_2.mp4" type="video/mp4">
                                        <#--                                    <strong>Your browser does not support the video tag.</strong>-->
                                    </video>
                                </div>
                            </div>
                ...
                <div class="tile_1_img_left">
                    <div class="row">
                        <div class="col-6 image-container" style="padding-right: 0px">
                            <div class="image">
                                <video autoplay muted loop>
                                    <source src="/videos/handle_heat_3.mp4" type="video/mp4">
                                    <#--                                    <strong>Your browser does not support the video tag.</strong>-->
                                </video>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-9 col-lg-9 ">
                        <div class="footer-copy-right">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                ...
                                </script>. Kwangjinwintec Inc. All rights reserved
