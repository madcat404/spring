    ...
    <div id="headerInnerWrap">
        ...
        <div id="headerInner" class="clearfix">
            <h1 class="logo">
                <a href="/index">
                    ...
                    <img src="/images/logo/logo_k_g_m_white.png" alt="아이윈" class="off-logo"/>
        ...
        <nav id="gnb" class="total-menu">
            ...
            <ul class="clearfix menu5 area">
                ...
                <li class="gnb2">
                    <a href="/product/coolseat">Product</a>
                    <div class="gnb-2dep">
                        <ul>
<#--                            <li><a href="/product/coolseat#seatheat"><span>시트히터</span></a></li>-->
<#--                            <li><a href="/product/coolseat#ventseat"><span>통풍시터</span></a></li>-->
<#--                            <li><a href="/product/coolseat#handle"><span>발열핸들</span></a></li>-->
<#--                            <li><a href="/product/coolseat#ecu"><span>ECU</span></a></li>-->
<#--                            <li><a href="/product/coolseat#warmer"><span>워머</span></a></li>-->
                ...
                <li class="gnb3">
                    ...
                    <div class="gnb-2dep">
                        <ul>
                            <li><a href="/investment/finance/cfs"><span>재무정보</span></a></li>
                ...
                <li class="gnb5">
                    <a href="/ethics/ethics1">Ethics</a>
                    <div class="gnb-2dep">
                        <ul>
                            <li><a href="/ethics/ethics1"><span>윤리강령</span></a></li>
                        </ul>
                    </div>
                </li>
            </ul>
...
<#--                                <a href="/index">-->
<#--                                    <#if device == "pc">-->
<#--                                        <img src="/images/logo/logo_k.png" alt="">-->
<#--                                    </#if>-->
<#--                                    <#if device == "mobile">-->
<#--                                        <img src="/images/logo/logo_k.png" alt="" style="width: 50%;">-->
<#--                                    </#if>-->
<#--                                </a>-->
<#--                            </div>-->
<#--                        </div>-->
...
<#--                            <!-- Main-menu &ndash;&gt;-->
<#--                            <div class="main-menu d-none d-lg-block pl-10">-->
<#--                                <nav>-->
<#--                                    <ul id="navigation">-->
<#--&lt;#&ndash;                                        <li class="li-5"><a href="/index" class="navi-text menus" data-sel="header-menu">HOME</a>&ndash;&gt;-->
<#--&lt;#&ndash;                                        </li>&ndash;&gt;-->
<#--                                        <li class="li-5"><a href="#" class="navi-text menus" data-sel="header-menu" sub-sel="header-title1">About Us</a>-->
<#--                                            <ul class="submenu">-->
<#--                                                <li>-->
<#--                                                    <a href="/about">인사말</a>-->
<#--                                                </li>-->
<#--                                                <li>-->
<#--                                                    <a href="/company/site">사업장 소개</a>-->
<#--                                                </li>-->
<#--                                                <li>-->
<#--                                                    <a href="/company/certi">인증</a>-->
<#--                                                </li>-->
...
<#--                                            </ul>-->
<#--                                        </li>-->
<#--                                        <li class="li-5"><a href="#" class="navi-text menus" data-sel="header-menu" sub-sel="header-title2">Product</a>-->
<#--                                            <ul class="submenu">-->
<#--                                                <li>-->
<#--                                                    <a href="/product/seatheat">시트히터</a>-->
<#--                                                </li>-->
<#--                                                <li>-->
<#--                                                    <a href="/product/handle">발열핸들</a>-->
<#--                                                </li>-->
<#--                                                <li>-->
<#--                                                    <a href="/product/coolseat">통풍시터</a>-->
<#--                                                </li>-->
<#--                                                <li>-->
<#--                                                    <a href="/product/ecu">ECU</a>-->
<#--                                                </li>-->
<#--                                                <li>-->
<#--                                                    <a href="/product/irwarmer">워머</a>-->
<#--                                                </li>-->
<#--                                            </ul>-->
<#--                                        </li>-->
<#--                                        <li class="li-5"><a href="#" class="navi-text menus" data-sel="header-menu" sub-sel="header-title3">Investment</a>-->
<#--                                            <ul class="submenu">-->
<#--                                                <li>-->
...
<#--                                <a href="/contact" class="btn_contact"><span>Contact Us</span></a>-->
<#--                            </div>-->
...
<#--                        <a href="/product/seatheat">Product</a>-->
<#--                        <ul>-->
<#--                            <li><a href="/product/seatheat">시트히터</a></li>-->
<#--                            <li><a href="/product/handle">발열핸들</a></li>-->
<#--                            <li><a href="/product/coolseat">통풍시터</a></li>-->
<#--                            <li><a href="/product/ecu">ECU</a></li>-->
<#--                            <li><a href="/product/irwarmer">워머</a></li>-->
<#--                        </ul>-->
<#--                    </li>-->
<#--                    <li class="">-->
<#--                        <em>03</em>-->
...
<#--                        <ul>-->
<#--                            <li><a href="/investment">재무정보</a></li>-->
...
<#--            </div>-->
<#--        </div>-->
<#--        <!-- <div class="allMenuWrap_dim winH"></div>  &ndash;&gt;-->
<#--    </div>-->
<#--    <!-- Header End &ndash;&gt;-->
<#--</header>-->
<main>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="hero-cap text-center pt-50">
                            <h2 data-aos="fade-right">아이윈 제품</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- 중간 네비게이션 -->
    <!--Services Area Start -->
<#--    <section class="section section__03 js-section_03">-->
<#--        <div class="section" id="seatheat">-->
<#--            <div class="section__column inview">-->
<#--                <div class="column__text aos-init aos-animate" data-aos="fade-right">-->
<#--                    <h3 class="section__title02">시트히터</h3>-->
<#--                    <p class="section__desc">겨울철 시트를 따뜻하게 하기 위한 장치-->
<#--                        <br><br>일정한 온도 유지 및 균일한 온도분포로 뛰어난 발열성능을 제공-->
<#--                        <br>과열방지 기능 및 각종 안전모드(FAIL SAFE) 적용으로 우수한 안정성 보장-->
<#--                    </p>-->
<#--&lt;#&ndash;                    <button class="section__button">&ndash;&gt;-->
<#--&lt;#&ndash;                        <a href="/product/handle">자세히 보기</a>&ndash;&gt;-->
<#--&lt;#&ndash;                    </button>&ndash;&gt;-->
<#--                </div>-->
<#--            </div>-->
<#--            <div class="section__column inview">-->
<#--                <img src="/images/prod/02_f.png" alt="Complete Seats" data-aos="fade-up" class="aos-init aos-animate">-->
<#--            </div>-->
<#--        </div>-->
<#--        <div class="section" id="handle">-->
<#--            <div class="section__column inview">-->
<#--                <img src="/images/prod/03_f.png" alt="Structure &amp; Mechanism" data-aos="fade-up"-->
<#--                     class="aos-init aos-animate">-->
<#--            </div>-->
<#--            <div class="section__column inview">-->
<#--                <div class="column__text aos-init" data-aos="fade-left">-->
<#--                    <h3 class="section__title02">발열핸들</h3>-->
<#--                    <p class="section__desc">겨울철 핸들을 따뜻하게 하기 위한 장치-->
<#--                        <br><br>핸들 표면의 냉기를 빠른 시간안에 제거하여 운전자에게 쾌적한 온기를 제공-->
<#--                        <br>전용 열선 적용으로 이물감이 없으며 그립감 개선을 위한 베이스 원단 적용-->
<#--                    </p>-->
<#--&lt;#&ndash;                    <button class="section__button">&ndash;&gt;-->
<#--&lt;#&ndash;                        <a href="/product/seatheat">자세히 보기</a>&ndash;&gt;-->
<#--&lt;#&ndash;                    </button>&ndash;&gt;-->
<#--                </div>-->
<#--            </div>-->
<#--        </div>-->
<#--        <div class="section" id="ventseat">-->
<#--            <div class="section__column inview">-->
<#--                <div class="column__text aos-init" data-aos="fade-right">-->
<#--                    <h3 class="section__title02">통풍시트</h3>-->
<#--                    <p class="section__desc">여름철 시트를 시원하게 하기 위한 장치-->
<#--                        <br><br>차량 공조장치에 의한 시원한 차량 내부 공기를 전동식 팬을 통해 시트 내부로 순환시켜-->
<#--                        <br>여름철 운전자의 엉덩이와 등의 땀과 열을 제거하여 쾌적한 운전환경 제공-->
<#--                    </p>-->
<#--&lt;#&ndash;                    <button class="section__button">&ndash;&gt;-->
<#--&lt;#&ndash;                        <a href="/product/coolseat">자세히 보기</a>&ndash;&gt;-->
<#--&lt;#&ndash;                    </button>&ndash;&gt;-->
<#--                </div>-->
<#--            </div>-->
<#--            <div class="section__column inview">-->
<#--                <img src="/images/prod/ecu.png" alt="Core Components" data-aos="fade-up" class="aos-init">-->
<#--            </div>-->
<#--        </div>-->
<#--&lt;#&ndash;        <div class="section">&ndash;&gt;-->
<#--&lt;#&ndash;            <div class="section__column inview">&ndash;&gt;-->
<#--&lt;#&ndash;                <div class="column__text aos-init" data-aos="fade-right">&ndash;&gt;-->
<#--&lt;#&ndash;                    <h3 class="section__title02">ECU</h3>&ndash;&gt;-->
<#--&lt;#&ndash;                    <p class="section__desc">ELECTRONIC CONTROL UNIT&ndash;&gt;-->
<#--&lt;#&ndash;                        <br><br>설정된 저항값 차이에 따라 전원을&ndash;&gt;-->
<#--&lt;#&ndash;                        <br>인가시켜주거나 차단하여&ndash;&gt;-->
<#--&lt;#&ndash;                        <br>Heating을 구동시켜주는 장치&ndash;&gt;-->
<#--&lt;#&ndash;                    </p>&ndash;&gt;-->
<#--&lt;#&ndash;                    <button class="section__button">&ndash;&gt;-->
<#--&lt;#&ndash;                        <a href="/product/coolseat">자세히 보기</a>&ndash;&gt;-->
<#--&lt;#&ndash;                    </button>&ndash;&gt;-->
...
<#--&lt;#&ndash;            </div>&ndash;&gt;-->
<#--&lt;#&ndash;            <div class="section__column inview">&ndash;&gt;-->
<#--&lt;#&ndash;                <img src="/images/prod/ecu.png" alt="Core Components" data-aos="fade-up" class="aos-init">&ndash;&gt;-->
<#--&lt;#&ndash;            </div>&ndash;&gt;-->
<#--&lt;#&ndash;        </div>&ndash;&gt;-->
<#--    </section>-->
<#--    <section class="section section__03_2 js-section_03">-->
<#--        <div class="section" id="warmer">-->
<#--            <div class="section__column inview">-->
<#--                <img src="/images/prod/03_f.png" alt="Structure &amp; Mechanism" data-aos="fade-up"-->
<#--                     class="aos-init aos-animate">-->
<#--            </div>-->
<#--            <div class="section__column inview">-->
<#--                <div class="column__text aos-init" data-aos="fade-left">-->
<#--                    <h3 class="section__title02">워머</h3>-->
<#--                    <p class="section__desc">겨울철 운전자의 무릎을 따뜻하게 하기 위한 장치-->
<#--                        <br><br>복사열 방출로 인한 운전자 무릎 부위의 냉기를 제거해주는 신개념 난방장치-->
<#--                        <br>CNT 발열체를 이용한 인체에 유익한 원적외선 방사-->
<#--                        <br>자기정전용량 방식의 전류차단 터치센서 적용을 통한 안정성 확보-->
<#--                    </p>-->
<#--                    <button class="section__button">-->
<#--                        <a href="/product/seatheat">자세히 보기</a>-->
<#--                    </button>-->
<#--                </div>-->
<#--            </div>-->
<#--        </div>-->
...
<#--            <div class="section__column inview">-->
<#--                <div class="column__text aos-init aos-animate" data-aos="fade-left">-->
<#--                    <h3 class="section__title02">ECU</h3>-->
<#--                    <p class="section__desc">시트히터, 발열핸들, IR 워머, 통풍시트를 구동시켜주는 장치-->
<#--                        <br><br>각 제품의 일정한 성능 유지 시켜 주며 안전기능 내장되어 과열 등 오작동 방지-->
<#--                        <br>CAN/LIN 통신 기능을 통한 각 제품의 동작 및 설정을 차량에서 가능하도록 지원-->
<#--                    </p>-->
<#--                    &lt;#&ndash;                    <button class="section__button">&ndash;&gt;-->
<#--                    &lt;#&ndash;                        <a href="/product/handle">자세히 보기</a>&ndash;&gt;-->
<#--                    &lt;#&ndash;                    </button>&ndash;&gt;-->
    ...
    <section class="section section__content section__comp_seat" style="margin-bottom: 0px;">
        <div class="views-row">
            <style>
                ...
                #title-1-section-1 .desktopOnly { display: block !important; }
                #title-1-section-1 .desktopOnlyInline { display: inline-block !important; }
                #title-1-section-1 .desktopOnlyFlex { display: flex !important; }
                #title-1-section-1 .mobileOnly,
                #title-1-section-1 .mobileOnlyInline,
                #title-1-section-1 .mobileOnlyFlex { display: none !important; }
                ...
                @media all and (max-width: 1000px) {
                    ...
                    #title-1-section-1 .desktopOnly,
                    #title-1-section-1 .desktopOnlyInline,
                    #title-1-section-1 .desktopOnlyFlex { display: none !important; }
                    #title-1-section-1 .mobileOnly { display: block !important; }
                    #title-1-section-1 .mobileOnlyInline { display: inline-block !important; }
                    #title-1-section-1 .mobileOnlyFlex { display: flex !important; }
...
<#--                            <div class="image" style="background: url('/images/1.jpg');">-->
                        ...
                        <div class="col-6 tile_1_info" style="margin-top: 30px;">
                            <div class="tile_1_header">통풍시터
                            </div>
                            <div class="tile_1_subheader"><p>여름철 쾌적한 운전환경 제공</p>
                            </div>
                            <div class="tile_1_body"><p>열과 습기를 FAN을 사용하여 공기를 강제 순환시켜 운전환경을 향상시킵니다.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="views-row">
            ...
            <section id="title-1-section-3">
                <div class="tile_1_img_left">
                    <div class="row">
                        <div class="col-6 image-container" style="padding-right: 0px">
<#--                            <div class="image" style="background: url('/images/3.jpg');"></div>-->
                            <video autoplay muted loop>
                                <source src="/videos/wind_seat_comp_v3.mp4" type="video/mp4">
                                <#--                                    <strong>Your browser does not support the video tag.</strong>-->
                            </video>
                        </div>
                        <div class="col-6 tile_1_info" style="margin-top: 30px;">
...
<#--                                    <a href="/index"><img src="/images/logo/logo_k_footer.png" alt=""></a>-->
<#--                                </div>-->
<#--                            </div>-->
<#--                        </div>-->
<#--                    </div>-->
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                <h4>HR</h4>
                                <ul>
                                    <li><a href="/hr/talent">인재상</a></li>
                                    <li><a href="/hr/welfare">복리후생</a></li>
                                    <li><a href="/hr/recruit">채용절차</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                ...
                                <p>부산광역시 기장군 장안읍 <br>장안산단9로 110</p>
                            </div>
                        </div>
                    </div>
                </div>
