                                    ...
                                    <div class="is-wauto-box">
                                        <table class="tbl-type01 gongsiTbl">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="colgroup">Author</th>
                                                <#--                                                <th scope="colgroup">작성일</th>-->
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <#if (macroConfigList?size > 0)>
                                                <#list macroConfigList as macro>
                                                    <tr>

                                                        <td>${macro.registerDatetime?string("yyyy-MM-dd")}</td>
                                                        <td><a href="/eng/board_details?idx=${macro.idx?replace(",", "")}">${macro.title}</a></td>
                                                        <td>${macro.memberId}</td>
                                                    </tr>
                                                </#list>
                                            </#if>
                                            </tbody>
