                                ...
                                <div class="is-wauto-box">
                                    <table class="tbl-type01 gongsiTbl">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="colgroup">Report name</th>
                                            <th scope="colgroup">Submitter</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <#if disclosureList??>
                                        ...
                                        <#else>
                                            <tr><td colspan="3" style="height: 150px;text-align: center;vertical-align: middle;">No data was retrieved.</td></tr>
                                        </#if>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="btnBox num1 mt-50 text-center">
                                <a href="http://dart.fss.or.kr/html/search/SearchCompany_M2.html?textCrpNM=아이윈"
                                   class="bw-btn" target="_blank" title="새창열기"><span
                                            class="nw">Financial Supervisory Service Electronic Disclosure System</span></a>
                            </div>
                        </div>
                    </div>
                </div>
