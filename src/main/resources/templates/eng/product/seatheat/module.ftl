...
<main>
    ...
    <section class="section section__content section__comp_seat" style="margin-bottom: 0px;">
                    ...
                    <div class="row">
                        <#if device == "mobile">
                            <div class="col-6 image-container mobileOnlyFlex" style="padding-left: 0px">
                                <div class="image">
                                    <video autoplay muted loop>
                                        <source src="/videos/seatheat02.mp4" type="video/mp4">
                                        <#--                                    <strong>Your browser does not support the video tag.</strong>-->
                                    </video>
                                </div>
                            </div>
        ...
        <div class="views-row">
            <section id="title-1-section-3">		<div class="tile_1_img_left">
                    <div class="row">
                        <div class="col-6 image-container" style="padding-right: 0px">
                            <div class="image">
                                <video autoplay muted loop>
                                    <source src="/videos/seatheat03.mp4" type="video/mp4">
                                    <#--                                    <strong>Your browser does not support the video tag.</strong>-->
                                </video>
                            </div>
                        </div>
