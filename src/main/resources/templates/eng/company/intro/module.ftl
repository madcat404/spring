                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-1 col-md-1">
                            <div class="logo">
                                <a href="/index"><img src="/images/logo/logo_k.png" alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-3">
                            <div class="header-right-btn f-right d-none d-lg-block">
                                <a href="/contact" class="btn header-btn">
                                    <!-- iocn -->
...
<main>
    ...
    <div class="slider-area slider-bg ">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-9 ">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInLeft" data-delay=".3s">MAIN SLIDE TITLE 1</h1>
                                <p data-animation="fadeInLeft" data-delay=".6s">SLIDE SUB TITLE 1</p>
                                <!-- Slider btn -->
                                <div class="slider-btns">
                                    <!-- Hero-btn -->
                                    <a data-animation="fadeInLeft" data-delay="1s" href="industries.html" class="btn radius-btn">TEMP BUTTON</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="hero__img d-none d-lg-block f-right">
                                <img src="/images/559x671.png" alt="" data-animation="fadeInRight" data-delay="1s">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-slider d-flex align-items-center slider-height ">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-9 ">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInLeft" data-delay=".3s">MAIN SLIDE TITLE 2</h1>
                                <p data-animation="fadeInLeft" data-delay=".6s">SLIDE SUB TITLE 2</p>
                                <!-- Slider btn -->
                                <div class="slider-btns">
                                    <!-- Hero-btn -->
                                    <a data-animation="fadeInLeft" data-delay="1s" href="industries.html" class="btn radius-btn">TEMP BUTTON</a>
                        ...
                        <div class="col-lg-6">
                            <div class="hero__img d-none d-lg-block f-right">
                                <img src="/images/559x671.png" alt="" data-animation="fadeInRight" data-delay="1.5s">>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-slider d-flex align-items-center slider-height ">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-9 ">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInLeft" data-delay=".3s">MAIN SLIDE TITLE 3</h1>
                                <p data-animation="fadeInLeft" data-delay=".6s">SLIDE SUB TITLE 3</p>
                                <!-- Slider btn -->
                                <div class="slider-btns">
                                    <!-- Hero-btn -->
                                    <a data-animation="fadeInLeft" data-delay="1s" href="industries.html" class="btn radius-btn">TEMP BUTTON</a>
        ...
        <div class="slider-shape d-none d-lg-block">
            <img class="slider-shape1" src="/images/66x62.png" alt="">
            <img class="slider-shape2" src="/images/46x97.png" alt="">
            <img class="slider-shape3" src="/images/71x97.png" alt="">
        </div>
        <!-- slider Social -->
...
<#--                                <span class="flaticon-server"></span>-->
                                <span style="width: 90px;height: 88px;background: url('/images/90x88.png') no-repeat; display: flex;"></span>
                            </div>
                            <div class="services-cap">
                                <h3><a href="/services">PRODUCT 1</a></h3>
                                <p>PRODUCT 1 INFO</p>
                                <a href="/services" class="get-btn"><i class="ti-arrow-right"></i>TEMP BUTTON</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<#--                                <span class="flaticon-green"></span>-->
                            ...
                            <div class="services-cap">
                                <h3><a href="/services">PRODUCT 2</a></h3>
                                <p>PRODUCT 2 INFO</p>
                                <a href="/services" class="get-btn"><i class="ti-arrow-right"></i>TEMP BUTTON</a>
                            </div>
                        </div>
...
<#--                                <span class="flaticon-servers"></span>-->
                            ...
                            <div class="services-cap">
                                <h3><a href="/services">PRODUCT 3</a></h3>
                                <p>PRODUCT 3 INFO</p>
                                <a href="/services" class="get-btn"><i class="ti-arrow-right"></i>TEMP BUTTON</a>
                            </div>
                        </div>
    ...
    <!-- Services Area End -->
    <!-- Search domain Start -->
    <section class="search-domain-area section-bg pt-140 pb-140" data-background="/images/gallery/section_bg02.jpg">
        <div class="container">
            ...
            <div class="row">
                <div class="domain-list">
                    <div class="single-domain">
                        <span>COMPANY INFO 1</span>
                        <p>INFORMATION 1</p>
                    </div>
                    <div class="single-domain">
                        <span>COMPANY INFO 2</span>
                        <p>INFORMATION 2</p>
                    </div>
                    <div class="single-domain">
                        <span>COMPANY INFO 3</span>
                        <p>INFORMATION 3</p>
                    </div>
                    <div class="single-domain">
                        <span>COMPANY INFO 4</span>
                        <p>INFORMATION 4</p>
                    </div>
                    <div class="single-domain">
                        <span>COMPANY INFO 5</span>
                        <p>INFORMATION 5</p>
                    </div>
                    <div class="single-domain">
                        <span>COMPANY INFO 6</span>
                        <p>INFORMATION 6</p>
                    </div>
                </div>
            </div>
    ...
    <!--All startups End -->
    <!-- Blog Area Start -->
    <section class="blogs-area section-padding30" style="padding-top: 50px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <!-- Section Tittle -->
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-blogs mb-100">
                        <div class="blog-img">
                            <img src="/images/340x355.png" alt="">
                        </div>
                        <div class="blog-cap">
                            <span class="color1">2021.05.14.</span>
                            <h4><a href="#">NEWS 1 TITLE</a></h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
