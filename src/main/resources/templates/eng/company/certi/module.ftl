...
<main>
    ...
    <div id="snb" class="snb_s01">
        <a href="#"><span>Quality Management</span></a>
        <ul class="snbSize_2">
            <li class="snb01 on"><a href="/eng/company/certi"><span>Quality Management</span></a></li>
            <li class="snb02"><a href="/eng/company/certi2"><span>Environmental Management</span></a></li>
        </ul>
    </div>
    <!-- 인증 내역 시작 -->
    <section id="content" class="area" style="margin-bottom: 100px;">
        ...
        <aside id="contentInfoCon">
            <h3 class="content-tit font-noto">IWIN first Pioneered the field of seat heaters for the first time in Korea</h3>
        </aside>
        ...
        <article class="talent-content">
            <article class="cm-style-tab-content-02">
                <article class="recruit-sec">
                    <#--                    <h4 class="recruit-sec-tit">채용절차</h4>-->
                    ...
                    <article class="certi-step-detail">
                        ...
                        <div class="inner">
                            <div class="left-con-eng">
                                <p class="txt">Value creation for customers</p>
                            </div>
                            <div class="right-con-eng font-noto">
                                <div class="txt">
                                    <p>We carry out innovative quality management activities to provide the best products and services to our customers.</p>
                                </div>
                            </div>
                        </div>
                        <div class="inner">
                            <div class="left-con-eng">
                                <p class="txt">Securing technological edge</p>
                            </div>
                            <div class="right-con-eng font-noto">
                                <div class="txt">
                                    <p>We pursue differentiation based on specialized technology through continuous research and development.</p>
                                </div>
                            </div>
                        </div>
                        <div class="inner">
                            <div class="left-con-eng">
                                <p class="txt">Best Competitiveness</p>
                            </div>
                            <div class="right-con-eng font-noto">
                                <div class="txt">
                                    <p>Best Competitiveness We have the best competitiveness through activities to improve the participation of all members, improve work efficiency, and continuously improve productivity.</p>
                                </div>
                            </div>
                        </div>
                        <div class="inner">
                            <div class="left-con-eng">
                                <p class="txt">Shifting thinking for challenge and innovation</p>
                            </div>
                            <div class="right-con-eng font-noto">
                                <div class="txt">
                                    <p>We are not satisfied with the reality, but always aim for a better future by thinking based on challenge and innovation.</p>
                                </div>
                            </div>
                        </div>
                    </article>
