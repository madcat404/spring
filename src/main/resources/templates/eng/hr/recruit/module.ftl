...
<main>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="hero-cap text-center pt-50">
                            <h2 data-aos="fade-up">Recruit</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="content" class="area" style="margin-bottom: 100px;">
        ...
        <aside id="contentInfoCon">
            <h3 class="content-tit font-noto">Recruitment process</h3>
        </aside>
        <article class="talent-content">
            ...
            <article class="cm-style-tab-content-02">
                ...
                <article class="recruit-sec">
                    <h4 class="recruit-sec-tit">Recruitment process</h4>
                    <article class="recruit-step-con">
                        <ul class="recruit-step-list clearfix">
                            <li>
                                <div class="inner">
                                    <strong class="step-num">STEP 01</strong>
                                    <span class="step-img"><img src="/images/icon/recruit_icon_01.png" alt="서류심사 전형" /></span>
                                    <p class="step-tit">Document screening</p>
                                </div>
                            </li>
                            <li>
                                <div class="inner">
                                    <strong class="step-num">STEP 02</strong>
                                    <span class="step-img"><img src="/images/icon/recruit_icon_02.png" alt="1차 실무면접 전형" /></span>
                                    <p class="step-tit">1st practical interview</p>
                                </div>
                            </li>
                            <li>
                                <div class="inner">
                                    <strong class="step-num">STEP 03</strong>
                                    <span class="step-img"><img src="/images/icon/recruit_icon_03.png" alt="2차 임원면접 전형" /></span>
                                    <p class="step-tit">2nd interview with executives</p>
                                </div>
                            </li>
                            <li>
                                <div class="inner">
                                    <strong class="step-num">STEP 04</strong>
                                    <span class="step-img"><img src="/images/icon/recruit_icon_04.png" alt="채용 건강검진,입사서류준비" /></span>
                                    <p class="step-tit">Recruitment Health Checkup,<br class="pc-br">Preparation of application documents</p>
                                </div>
                            </li>
                            <li>
                                <div class="inner">
                                    <strong class="step-num">STEP 05</strong>
                                    <span class="step-img"><img src="/images/icon/recruit_icon_05.png" alt="최종입사" /></span>
                                    <p class="step-tit">Final admission</p>
                                </div>
                            </li>
                        </ul>
                    </article>
                    <article class="recruit-step-detail">
                        <div class="inner">
                            <div class="left-con">
                                <p class="txt">STEP 01</p>
                            </div>
                            <div class="right-con font-noto">
                                <div class="tit">Document screening</div>
                                <div class="txt">
                                    <p>Only successful applicants will be notified individually</p>
                                </div>
                            </div>
                        </div>
                        <div class="inner">
                            <div class="left-con">
                                <p class="txt">STEP 02</p>
                            </div>
                            <div class="right-con font-noto">
                                <div class="tit">1st practical interview</div>
                                <div class="txt">
                                    <p>Personal Core Values and Job Competency Test</p>
                                </div>
                            </div>
                        </div>
                        <div class="inner">
                            <div class="left-con">
                                <p class="txt">STEP 03</p>
                            </div>
                            <div class="right-con font-noto">
                                <div class="tit">2nd interview with executives</div>
                                <div class="txt">
                                    <p>Verification of our talent and organizational suitability</p>
                                </div>
                            </div>
                        </div>
                        <div class="inner">
                            <div class="left-con">
                                <p class="txt">STEP 04</p>
                            </div>
                            <div class="right-con font-noto">
                                <div class="tit">Personality test, recruitment health checkup, preparation of admission documents</div>
                                <div class="txt">
                                    <p>Only for finalists</p>
                                </div>
                            </div>
                        </div>
                        <div class="inner">
                            <div class="left-con">
                                <p class="txt">STEP 05</p>
                            </div>
                            <div class="right-con font-noto">
                                <div class="tit">Final admission</div>
                            </div>
                        </div>
                    </article>
                </article>
                <article class="recruit-sec">
                    <div class="recruit-info-con clearfix">
                        <div class="recruit-info">
                            <h4 class="recruit-sec-tit">Working conditions and environment</h4>
                            <div class="info-txt-wrap">
                                <dl class="info-txt clearfix">
                                    <dt>Work type</dt>
                                    <dd>Full-time</dd>
                                </dl>
                                <dl class="info-txt clearfix">
                                    <dt>Working hours</dt>
                                    <dd>5 days a week (Mon-Fri)</dd>
                                </dl>
                                <dl class="info-txt clearfix">
                                    <dt>Work area</dt>
                                    <dd>Busan (Headquarters)</dd>
                                </dl>
                                <dl class="info-txt clearfix">
                                    <dt>Salary conditions</dt>
                                    <dd>Company bylaws</dd>
                                </dl>
                            </div>
                        </div>
                        <div class="recruit-info">
                            <h4 class="recruit-sec-tit">How to apply</h4>
                            <div class="info-txt-wrap">
                                <dl class="info-txt clearfix">
                                ...
                                <dl class="info-txt clearfix">
                                    <dt>How to apply</dt>
                                    <dd>Saramin support</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                    <div class="recruit-notice-con">
                        <h4 class="recruit-sec-tit">Notes and cautions</h4>
                        <p class="notice-txt">
                            If the submitted documents are found to be false, the admission may be cancelled.<br>
                            When conducting an interview with an executive, you must submit your degree certificate and final experience certificate.<br>
                            Recruitment documents will be destroyed in accordance with the [Personal Information Protection Act] and [Act on Fair Recruitment Process].<br>
                        </p>
                    </div>
                    <div class="recruit-bottom">
                        <p class="email">
                            <span class="txt01"><i class="xi-mail-o icon"></i>Recruitment inquiry</span>
                            <span class="txt02">hr@iwin.kr</span>
                        </p>
                        <a href="https://www.saramin.co.kr/zf_user/company-info/view?csn=S1dDamhEN1B6MjdaREpkdmlWMDMxZz09" class="apply-btn">Apply</a>
                    </div>
                </article>
            </article>
        </article>
