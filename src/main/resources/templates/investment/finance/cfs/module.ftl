        ...
        <article class="ir-content">
            ...
            <aside class="sub-tab-list-style">
                <ul class="tab-list col-03 clearfix">
                    <li class="selected"><a href="/investment/finance/cfs"><em>연결</em></a></li>
                    <li><a href="/investment/finance/ofs"><em>개별</em></a></li>
                </ul>
            </aside>
            <!-- // -->
...
<#--                            </div>-->
                ...
                <section class="tbl">
                    <article class="table01 stock03-table">
                        <h1 class="tbl-tit clearfix">재무상태표(연결) <span>(단위 : 백만원)</span></h1>
                        <div class="stockTbl-wrapper">
                ...
                datasets: [
                    {
                        ...
                        data: [ 2255, 2032, 2660 ],
                        <#--data: [ ${(2266)?int?replace(",", "")}, ${(2032)?int?replace(",", "")}, ${(1111)?int?replace(",", "")}  ],-->
...
<#--label: '영업이익 (단위: 백만원)',-->
<#--lineTension: 0,-->
<#--data: [ ${(resList[0].salesLoss?number/1000000)?replace(",", "")}, ${(resList[1].salesLoss?number/1000000)?replace(",", "")}, ${(resList[2].salesLoss?number/1000000)?replace(",", "")} ],-->
<#--// fill: false,-->
<#--// pointBorderWidth: 5,-->
<#--// pointHoverBorderWidth: 15,-->
<#--// borderColor: 'rgb(37, 34, 255)'-->
<#--backgroundColor: 'rgb(37, 34, 255)'-->
<#--},-->
<#--{-->
<#--label: '순이익 (단위: 백만원)',-->
<#--lineTension: 0,-->
<#--data: [ ${(resList[0].currentIncome?number/1000000)?replace(",", "")}, ${(resList[1].currentIncome?number/1000000)?replace(",", "")}, ${(resList[2].currentIncome?number/1000000)?replace(",", "")} ],-->
<#--// fill: false,-->
<#--// pointBorderWidth: 5,-->
<#--// pointHoverBorderWidth: 15,-->
<#--// borderColor: 'rgb(228, 29, 204)'-->
<#--backgroundColor: 'rgb(228, 29, 204)'-->
<#--}-->
<!-- Chart -->
</body>
</html>